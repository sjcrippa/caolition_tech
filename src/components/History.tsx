...
export default function History() {
  return (
    <section id='history' className='relative' >
      ...
      <article className='absolute py-20 sm:py-24 max-w-screen-sm sm:max-w-screen-xl sm:left-1/2 sm:-translate-x-1/2'>
